      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption text-start">
            ...
            <p><a class="btn btn-lg btn-primary" href="#" role="button" onClick="javascript: window.location='?page=br__customer_page'; ">Sign up today</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="container">
          <div class="carousel-caption">
            ...
            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
            <p><a class="btn btn-lg btn-primary" href="#" role="button" onClick="javascript: window.location='?page=br__customer_page'; ">Sign Up</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item">
    ...
    <div class="row featurette">
      <div class="col-md-7">
      	...
      	<center>
            ...
            <input type="email" id="br__email" class="form-control" placeholder="Email address" required autofocus>
            <label for="inputPassword" class="visually-hidden">Password</label>
            <input type="password" id="br__password" class="form-control" placeholder="Password" required>
            ...
            <button class="w-100 btn btn-lg btn-primary" id="br__login" type="submit">Sign in</button>
            <a href="?page=br__customer_page&action=resetpass">Reset Password</a>
